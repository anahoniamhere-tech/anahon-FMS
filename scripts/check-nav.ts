...
const placed: Record<string, string[]> = {
  ...
  "Digital Officer": ["doors", "mydesk", "help", "handbooks", "social", "live", "website", "archive", "tools", "network", "payroll"],
  "Chief Editor": ["doors", "mydesk", "help", "handbooks", "editorial", "social", "live", "website", "archive", "payroll"],
  "Production Manager": ["doors", "mydesk", "help", "handbooks", "editorial", "social", "live", "website", "archive", "payroll"],
