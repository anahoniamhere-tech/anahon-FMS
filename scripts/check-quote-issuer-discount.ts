...
assert.ok(ic.includes("A programme of AnaHon (Lebanese Civil Company 90/2023) · MOF 3893185"), "the legal line stays true");
assert.ok(ic.includes("For iContent Studio (AnaHon) — date &amp; signature"), "signature block");
...
assert.ok(ic.includes("AnaHon may revise the prices"), "the revision clause is unchanged");
