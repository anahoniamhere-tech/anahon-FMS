...
export interface DatabaseState {
  ...
  anna?: { enabled: boolean; voice?: boolean; speech?: boolean; arabicVoice?: boolean; spend?: { month: string; modelsUSD: number; voiceUSD: number; limitUSD: number; speechChars?: number; speechLimit?: number } | null };
