...
export const HELP: HelpEntry[] = [
  ...
  // ---- Website -----------------------------------------------------------------
  {
    ...
    a: {
      ...
      ar: "يعرض الموقع الحقيقي من خادم التحرير. فعّل «التحرير»، انقر أي نص لتغييره، اسحب صورة من اللوحة إلى أي صورة، أو اسحب بودكاست أو فيلماً وثائقياً أو مقالاً إلى عناصر الصفحة الرئيسية لتثبيته. كل تغيير يُكتب في ملفات الموقع وتُعاد الصفحة؛ ما تراه هو ما تقوله الملفات. حدّان: كلمات المقال تُحرَّر في مكتب التحرير — النقر عليها هناك يفتحه — وإفلات الصور أو مواد المكتبة يحتاج إلى حاسوب؛ على الهاتف ما زال بإمكانك النقر على النص لتحريره. «محتوى الموقع» يحرّر الكلمات نفسها كنموذج، قسماً قسماً.",
    },
  },
  {
