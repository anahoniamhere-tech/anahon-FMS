...
export const HELP: HelpEntry[] = [
  ...
  // ---- Website -----------------------------------------------------------------
  {
    ...
    a: {
      en: "It shows the real website from the editing server. Turn on Editing, click any text to change it, drop a picture from the panel onto any image, or click a widget (the hero slider, latest articles, episodes, the Articles and Podcasts pages) to see its whole list in the panel — reorder, remove, add from the library — or drop a library item on it to pin it first. Each change is written to the site’s files and the page reloads; what you see is what the files say. Two limits: an article’s words are edited in the Editorial desk — clicking one there opens it — and dropping pictures or library items needs a computer; on a phone you can still tap text to edit it. Click anything on the page and the Section panel opens that text’s whole section as a form — the other language, links, pictures, list order, the things a page cannot show — and Sections lists every section of the site, so nothing needs a second door.",
      ar: "يعرض الموقع الحقيقي من خادم التحرير. فعّل «التحرير»، انقر أي نص لتغييره، اسحب صورة من اللوحة إلى أي صورة، أو انقر عنصراً (شريط الواجهة، أحدث المقالات، الحلقات، صفحتا المقالات والبودكاست) لترى قائمته كاملة في اللوحة — رتّب وأزل وأضف من المكتبة — أو أفلت مادة من المكتبة عليه ليُثبَّت أولاً. كل تغيير يُكتب في ملفات الموقع وتُعاد الصفحة؛ ما تراه هو ما تقوله الملفات. حدّان: كلمات المقال تُحرَّر في مكتب التحرير — النقر عليها هناك يفتحه — وإفلات الصور أو مواد المكتبة يحتاج إلى حاسوب؛ على الهاتف ما زال بإمكانك النقر على النص لتحريره. انقر أي شيء في الصفحة تُفتح لوحة «القسم» على قسم ذلك النص كاملاً كنموذج — اللغة الأخرى والروابط والصور وترتيب القوائم وما لا تُظهره الصفحة — و«الأقسام» تسرد كل أقسام الموقع، فلا حاجة إلى باب ثانٍ.",
    },
  },
  {
  ...
  },
  {
    ...
    a: {
      en: "Ask for a calendar address on My Desk and open the webcal address on the phone — the calendar app then offers to subscribe. Opening it as a web page downloads the events once and forgets them, which is not the same thing; the address that starts with webcal is the one that keeps updating. It carries one all-day entry for every dated thing that is your turn, refreshed about every hour, and nothing that belongs to anyone else. The address is the whole key — anyone holding it can read your desk — so it is shown once, never looked up again, and works only from inside the office network or over Tailscale. If it is ever shared by mistake, press Replace it: the old address stops working immediately and every device subscribed to it must be added again.",
